<template>
  <demo-section>
    <demo-block :title="$t('title1')">
      <ii-button @click="showToast">{{ $t('title1') }}</ii-button>
    </demo-block>

    <demo-block :title="$t('title2')">
      <ii-button @click="showLoadingToast">{{ $t('title2') }}</ii-button>
    </demo-block>

    <demo-block :title="$t('title3')">
      <ii-button @click="showSuccessToast">{{ $t('success') }}</ii-button>
      <ii-button @click="showFailToast">{{ $t('fail') }}</ii-button>
    </demo-block>

    <demo-block :title="$t('advancedUsage')">
      <ii-button @click="showCustomizedToast">{{ $t('advancedUsage') }}</ii-button>
    </demo-block>
  </demo-section>
</template>
