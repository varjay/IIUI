...
test('switch checkbox', () => {
  ...
  const icon = wrapper.find('.ii-checkbox__icon');
  icon.trigger('click');
  icon.trigger('click');
...
test('disabled', () => {
  ...
  wrapper.find('.ii-checkbox__icon').trigger('click');
...
test('label disabled', () => {
  ...
  wrapper.find('.ii-checkbox__label').trigger('click');
  expect(wrapper.emitted('input')).toBeFalsy();
});
...
test('checkbox group', () => {
  ...
  const icons = wrapper.findAll('.ii-checkbox__icon');
