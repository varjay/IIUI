...
```html
<ii-area :area-list="areaList" value="110101" />
```
...
```html
<ii-area :area-list="areaList" :columns-num="2" title="Title" />
```
...
All code of China: [Area.json](https://github.com/varjay/IIUI/blob/master/packages/area/demo/area-en.js)
