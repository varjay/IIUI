...
>
  ...
  <template slot="sku-actions" slot-scope="props">
    <div class="van-sku-actions">
      <ii-button bottom-action @click="onPointClicked">Button</ii-button>
      <!-- trigger sku inner event -->
      <ii-button type="primary" bottom-action @click="props.skuEventBus.$emit('sku:buy')">Button</ii-button>
    </div>
  </template>
</ii-sku>
```
