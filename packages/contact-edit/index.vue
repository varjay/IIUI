<template>
  <div :class="b()">
    ...
    <div :class="b('buttons')">
      <ii-button block :loading="isSaving" @click="onSave" type="primary">{{ $t('save') }}</ii-button>
      <ii-button block :loading="isDeleting" @click="onDelete" v-if="isEdit">{{ $t('delete') }}</ii-button>
    </div>
  </div>
</template>
