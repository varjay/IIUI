...
test('simple columns confirm & cancel event', () => {
  ...
  wrapper.find('.ii-picker__confirm').trigger('click');
  wrapper.find('.ii-picker__cancel').trigger('click');
...
test('drag columns', () => {
  ...
  triggerDrag(wrapper.find('.ii-picker-column'), 0, 0);
  triggerDrag(wrapper.find('.ii-picker-column'), 0, -100);
